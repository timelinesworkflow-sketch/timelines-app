            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <StagePageContent stageName="materials" stageDisplayName="Materials">
                    <div className="space-y-6">
                        {/* TABS - Custom responsive design */}
                        <div className="border-b border-gray-200 dark:border-gray-700 mb-6">
                            <div className="flex flex-nowrap overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 space-x-6 pb-px no-scrollbar">
                                <button
                                    onClick={() => setActiveTab("items")}
                                    className={`whitespace-nowrap pb-4 text-sm font-medium transition-colors relative border-b-2 flex-shrink-0 ${activeTab === "items"
                                ...
                                <button
                                    ...
                                    className={`whitespace-nowrap pb-4 text-sm font-medium transition-colors relative border-b-2 flex-shrink-0 ${activeTab === "inventory"
                                        ? "text-indigo-500 border-indigo-500"
                                        : "text-gray-400 hover:text-gray-300 border-transparent"
                                        }`}
                                >
                                ...
                                <div className="flex-1"></div> {/* Spacer to push refresh to right */}
                                <button
                                    onClick={loadData}
                                    className="hidden sm:block pb-4 text-gray-400 hover:text-gray-200"
                                    title="Refresh"
                                >
                            ...
                            <div className="space-y-4">
                                {loading ? (
                                    ...
                                    <div className="text-center py-12 bg-gray-800 rounded-xl border-2 border-dashed border-gray-700">
                                        ...
                                        <h3 className="text-lg font-medium text-gray-200">No items pending materials</h3>
                                        <p className="text-gray-400">All items are stocked or moved to marking.</p>
                                    </div>
                                ) : (
                                    items.map(item => {
